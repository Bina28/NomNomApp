...
public static class JwtServiceCollectionExtensions
{
    public static IServiceCollection AddJwt(this IServiceCollection services)
    {
        services
            ...
            .Validate(o => o.Key!.Length >= 64, "JWT Key must be at least 64 characters long")
            ...
            .Validate(o => o.ExpiryMinutes <= 1440, "JWT ExpiryMinutes must not exceed 24 hours")
            .ValidateOnStart();
    ...
    public static IServiceCollection AddJwt(this IServiceCollection services, Action<JwtOptions> configure)
        => services.AddJwt().Configure(configure);
}
